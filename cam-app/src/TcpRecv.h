...
{
public:
	static cn::ThreadSafeQueue<cn::seisys::rbx::comm::bean::multi::FusionPathDatas> fusionQueue_;
public:
	//static cn::ThreadSafeQueue<cn::seisys::rbx::comm::bean::multi::FusionPathDatas> FusionQueue;
